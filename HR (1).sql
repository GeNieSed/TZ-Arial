...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 13 2024 г., 19:11
...
(2, 'Ключников', 'Иван', 'Александрович', 4, 4, 4),
...
--
ALTER TABLE `Employee`
  MODIFY `ID_employee` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT для таблицы `Finances`
--
ALTER TABLE `Finances`
  MODIFY `ID_finances` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT для таблицы `Passport`
--
ALTER TABLE `Passport`
  MODIFY `ID_passport` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
